...
export default async function CategoryPage({ params }: Props) {
  ...
  const jsonLd = {
    ...
    description: data.description,
    url: `https://calculabs.com.br/${data.slug}`,
    breadcrumb: {
      "@type": "BreadcrumbList",
      itemListElement: [
        { "@type": "ListItem", position: 1, name: "Início", item: "https://calculabs.com.br" },
        { "@type": "ListItem", position: 2, name: data.name, item: `https://calculabs.com.br/${data.slug}` },
      ],
    },
  };
