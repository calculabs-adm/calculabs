...
2026-04-10 — LCP optimization: CookieConsent lazy-loaded to prevent banner impact on LCP. Reservado espaço estável (`minHeight`) em `AdBlock` para reduzir CLS em carregamento de anúncios e manter previsibilidade de layout.
