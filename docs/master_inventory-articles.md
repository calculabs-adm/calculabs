# Master Inventory — Articles

Inventário oficial de artigos do Knowledge Hub. Todo artigo DEVE estar registrado aqui antes de existir em `src/data/articles.json`.

## Regras

- Slug único (sem duplicatas)
- Status: `planejado` → `em_producao` → `publicado`
- Tipo: `pillar` (conteúdo principal) ou `satellite` (conteúdo de suporte)
- Inventário é fonte primária de controle

## Artigos

| ID | Slug | Title | Cluster | Tipo | Status | Priority |
|----|------|-------|---------|------|--------|----------|
| 1 | juros-compostos-guia-completo | Guia Completo de Juros Compostos | juros-compostos | pillar | publicado | high |
...
2026-04-10 — Inventário sincronizado com 30 artigos publicados. Clusters: engenharia-cimento (7), fisica-basica (9), juros-compostos (2), gestao-financeira-pessoal (8), matematica-basica (3), saude-imc (1).
